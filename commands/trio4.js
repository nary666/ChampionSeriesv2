...
module.exports.run = async (blaki, message, args) => {
    ...
    const gra5 = "**KLUCZ DO GRY 5 POJAWI SIĘ O GODZINIE 21:00**"
    const check = '609356000943931402'
  
    if(!message.member.roles.has(HOST.id)) return message.reply("Ooops, nie posiadasz uprawnień!");
    if(!args[0]) return message.channel.send("❌ _Wprowadź prawidłowe wartości, **.trio4 hasło **_ ❌").then(() =>
    {
    ...
    .setColor("#FFC125")
    .setTitle("**ARENA TRIO CUSTOM - GAME 4 !**")
    ...
    .setFooter("Gra zacznie się o godzinie 20:35 | Bot stworzony przez gs_nary#1297", "https://i.imgur.com/U26NLKj.png");
